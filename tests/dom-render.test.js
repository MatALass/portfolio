...
const translationElementIds = [
  ...
  'github-latest-label',
  'lab-kicker-text',
  'lab-project-title-text',
  'lab-project-copy-text',
  'lab-live-link',
  'lab-github-link',
  'lab-browser-open',
  'lab-back-link',
  'lab-embed-label-text',
  'lab-embed-hint-text',
  'lab-placeholder-title-text',
  'lab-placeholder-link',
  'contact-title-text',
  'contact-note-text',
  'contact-resume-text',
  'footer-note-text',
...
test('applyStaticTranslations updates static DOM content for French', () => {
  ...
  assert.match(elements.get('lab-points-list').innerHTML, /Algorithmes/);
});
